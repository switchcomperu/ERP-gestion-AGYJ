        ...
        <div
            ...
            <form class="space-y-4">
                ...
                <div class="ltr:text-right rtl:text-left">
                    <a href="{{ url('reset-pw') }}" class="text-black dark:text-white">Forgot Password?</a>
                </div>
                <button type="submit"
            ...
            <p class="mt-5 text-center text-muted dark:text-darkmuted">Not a Member yet? <a href="{{ url('signup') }}"
