...
@section('content')
    ...
    <div class="min-h-[calc(100vh-134px)] py-4 px-4 sm:px-12 flex justify-center items-center max-w-[1440px] mx-auto">
        <div
            ...
            <h1 class="text-2xl font-semibold mb-2 text-center dark:text-white">Sign Up</h1>
            ...
            <div class="flex flex-wrap items-center gap-4 mb-7">
                <a href="javaScript:void(0);"
                    class="flex flex-1 items-center gap-1 btn border border-light dark:text-white dark:hover:text-black rounded-md text-black transition-all duration-300 hover:bg-light hover:text-black">
            ...
            <div class="flex items-center mb-7">
                ...
                <div class="px-5 text-muted whitespace-nowrap capitalize dark:text-darkmuted">Or with Email</div>
                <div class="w-full h-[2px] bg-black/10 dark:bg-darkborder"></div>
            </div>
            ...
            <p class="text-center mt-5 text-muted dark:text-darkmuted">Already a member? <a href="{{ route('login') }}"
